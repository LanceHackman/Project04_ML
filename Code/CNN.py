...
def save_model(model, char_to_id):
    ...
    with open('../Misc/char_to_id.json', 'w') as f:
...
def load_cnn_model():
    ...
    model = keras.models.load_model('../Models/hexameter_cnn_model.keras')
    with open('../Misc/char_to_id.json', 'r') as f:
...
if __name__ == "__main__":
    ...
    data = load_data('../Misc/hexameter_lines.json')
