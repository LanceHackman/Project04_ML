...
import CNN
import Alatius
import Transformer  # New import

"""
Answers on Hexameter.co
Collects lines for data
"""
...
def collect_latin_line(driver):
    """
    Find the latin line on the page
    :param driver:
    :return: the line
    """
    try:
...
if __name__ == "__main__":
    ...
    print("4. Alatius Web Service")
    translator_type = int(input("Enter choice (1-4): "))
    ...
    elif translator_type == 3:
        print("Loading Transformer model...")
        model, char_to_id = Transformer.load_transformer_model()
        get_scansion = lambda line: Transformer.predict_transformer(model, char_to_id, line)
    ...
    output_file = "hexameter_lines.json"
    time.sleep(1.0)
